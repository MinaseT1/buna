...
import { Home, Package, Upload, Truck, CheckCircle, Users, MessageCircle, Link2, Wallet, Settings, HelpCircle, Menu, X } from "lucide-react";
...
const menu = [
  { label: "Dashboard", icon: Home, href: "/dashboard/exporter" },
  { label: "Assigned Lots", icon: Package, href: "/dashboard/exporter/assigned-lots" },
  { label: "Upload Export Documents", icon: Upload, href: "/dashboard/exporter/upload-documents" },
  { label: "In Transit", icon: Truck, href: "/dashboard/exporter/in-transit" },
  { label: "Completed Exports", icon: CheckCircle, href: "/dashboard/exporter/completed-exports" },
  { label: "Importers", icon: Users, href: "/dashboard/exporter/importers" },
  { label: "Messages", icon: MessageCircle, href: "/dashboard/exporter/messages" },
  { label: "Transactions", icon: Link2, href: "/dashboard/exporter/transactions" },
  { label: "Wallet & Earnings", icon: Wallet, href: "/dashboard/exporter/wallet" },
  { label: "Settings", icon: Settings, href: "/dashboard/exporter/settings" },
  { label: "Help & Support", icon: HelpCircle, href: "/dashboard/exporter/help" }
];
