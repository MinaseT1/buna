...
import { Home, Package, Truck, MessageCircle, Link2, Settings, Menu, X, Users, Clipboard, DollarSign } from "lucide-react";
...
const menu = [
  { label: "Dashboard", icon: Home, href: "/dashboard/processor" },
  { label: "Incoming Lots", icon: Package, href: "/dashboard/processor/incoming-lots" },
  { label: "My Processing Lots", icon: Truck, href: "/dashboard/processor/processing-lots" },
  { label: "Record Processing", icon: Clipboard, href: "/dashboard/processor/record" },
  { label: "Ready for Export", icon: Truck, href: "/dashboard/processor/export" },
  { label: "Linked Farmers", icon: Users, href: "/dashboard/processor/farmers" },
  { label: "Messages", icon: MessageCircle, href: "/dashboard/processor/messages" },
  { label: "Transactions", icon: Link2, href: "/dashboard/processor/transactions" },
  { label: "Wallet & Earnings", icon: DollarSign, href: "/dashboard/processor/wallet" },
  { label: "Settings", icon: Settings, href: "/dashboard/processor/settings" },
];
